...
class FormSosial extends StatefulWidget {
  @override
  _FormLingkunganState createState() => _FormLingkunganState();
}

class _FormLingkunganState extends State<FormSosial> {
  ...
  final String _jenisLayanan = 'Sosial'; // otomatis "Sosial"
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 4),
                                  Text(
                                    'Form ini diperuntukkan untuk pengaduan Sosial Seperti tawuran, masalah rumah tangga, bantuan sosial, kesehatan, pendidikan dan lainnya.',
                                    style: TextStyle(
                                        fontSize: 14,
