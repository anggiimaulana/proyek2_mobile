...
class FormInfrastruktur extends StatefulWidget {
  @override
  _FormLingkunganState createState() => _FormLingkunganState();
}

class _FormLingkunganState extends State<FormInfrastruktur> {
  ...
  final String _jenisLayanan = 'Infrastruktur'; // otomatis "Lingkungan"
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 4),
                                  Text(
                                    'Form ini diperuntukkan untuk pengaduan Infrastruktur Seperti jalan rusak, penerangan jalan, bangunan rusak, drainase dan lainnya.',
                                    style: TextStyle(
