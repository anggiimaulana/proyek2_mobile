...
class SkbmScreen extends StatefulWidget {
  const SkbmScreen({super.key});

  @override
  State<SkbmScreen> createState() => _SkbmScreenState();
}

class _SkbmScreenState extends State<SkbmScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer3<SkbmProvider, DataProvider, KartuKeluargaProvider>(
  ...
  Widget buildDropdownNIK(DataProvider dataProvider, SkbmProvider provider,
