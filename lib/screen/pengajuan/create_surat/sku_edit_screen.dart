...
class SkuCreateScreen extends StatefulWidget {
  const SkuCreateScreen({super.key});

  @override
  State<SkuCreateScreen> createState() => _SkuCreateScreenState();
}

class _SkuCreateScreenState extends State<SkuCreateScreen> {
  ...
  Widget build(BuildContext context) {
    return Consumer3<SkuCreateProvider, DataProvider, KartuKeluargaProvider>(
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildTextField(
                      'Masukkan nama usaha', provider.namaUsahaController),
                  ...
                  buildLabel('Upload Kartu Tanda Penduduk', isRequired: true),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              provider.selectedFileName ?? 'Pilih file KTP...',
  ...
  Widget buildDropdownNIK(DataProvider dataProvider, SkuCreateProvider provider,
