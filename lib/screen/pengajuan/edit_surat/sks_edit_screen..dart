...
class SksEditScreen extends StatefulWidget {
  final int detailId;
  ...
  @override
  State<SksEditScreen> createState() => _SksEditScreenState();
}

class _SksEditScreenState extends State<SksEditScreen> {
  ...
  Future<void> _loadSksData() async {
    ...
    try {
      final skuData = await provider.fetchSksById(widget.detailId.toString());
