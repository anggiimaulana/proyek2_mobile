...
class SktmListrikEditScreen extends StatefulWidget {
  final int detailId;
  final dynamic kategoriPengajuan;
  final String? pengajuanId;
  final String? catatan;

  const SktmListrikEditScreen({
    super.key,
  ...
  @override
  State<SktmListrikEditScreen> createState() => _SktmListrikEditScreenState();
}

class _SktmListrikEditScreenState extends State<SktmListrikEditScreen> {
