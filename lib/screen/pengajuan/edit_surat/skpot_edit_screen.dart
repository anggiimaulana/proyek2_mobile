...
class SkpotEditScreen extends StatefulWidget {
  final int detailId;
  final dynamic kategoriPengajuan;
  final String? pengajuanId;
  final String? catatan;

  const SkpotEditScreen({
    super.key,
  ...
  @override
  State<SkpotEditScreen> createState() => _SkpotEditScreenState();
}

class _SkpotEditScreenState extends State<SkpotEditScreen> {
  ...
  Future<void> _loadSkpot() async {
    ...
    try {
      final skpotBeasiswa =
          await provider.fetchSkpotById(widget.detailId.toString());
