...
class SktmBeasiswaEditScreen extends StatefulWidget {
  final int detailId;
  final dynamic kategoriPengajuan;
  final String? pengajuanId;
  final String? catatan;

  const SktmBeasiswaEditScreen({
    super.key,
  ...
  @override
  State<SktmBeasiswaEditScreen> createState() => _SktmBeasiswaEditScreenState();
}

class _SktmBeasiswaEditScreenState extends State<SktmBeasiswaEditScreen> {
