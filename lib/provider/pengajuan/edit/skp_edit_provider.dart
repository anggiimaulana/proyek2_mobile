...
class SkpEditProvider extends ChangeNotifier {
  ...
  int? selectedPekerjaanTerdahuluId;
  int? selectedPekerjaanSekarangId;
  ...
  void setSelectedPekerjaanTerdahuluId(int? value) {
    selectedPekerjaanTerdahuluId = value;
    notifyListeners();
  }

  void setSelectedPekerjaanSekarangId(int? value) {
    selectedPekerjaanSekarangId = value;
    notifyListeners();
  }
  ...
  void setSelectedNik(
    ...
    selectedPekerjaanTerdahuluId = anggota.pekerjaan;
  ...
  void fillFormWithExistingDataUpdate({
    ...
    selectedPekerjaanTerdahuluId = findIdByName(
      pekerjaanList,
      skuData['pekerjaan_terdahulu']?.toString(),
      (item) => item.namaPekerjaan,
      (item) => item.id,
    );
    selectedPekerjaanSekarangId = findIdByName(
      pekerjaanList,
  ...
  Future<int> updateForm(BuildContext context, String detailId) async {
    ...
    try {
      ...
      if (selectedPekerjaanTerdahuluId == null) missingFields.add('Pekerjaan');
      ...
      final Map<String, String> data = {
        ...
        'pekerjaan_terdahulu': selectedPekerjaanTerdahuluId?.toString() ?? '',
        'pekerjaan_sekarang': selectedPekerjaanSekarangId?.toString() ?? '',
  ...
  void resetForm() {
    ...
    selectedPekerjaanTerdahuluId = null;
    selectedPekerjaanSekarangId = null;
