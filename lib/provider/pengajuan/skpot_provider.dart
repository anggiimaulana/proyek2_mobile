...
class SkpotProvider extends ChangeNotifier {
  ...
  int? selectedPenghasilanOrtuIdCreate;
  ...
  int? selectedPenghasilanOrtuIdUpdate;
  ...
  int? selectedPenghasilanOrtuId(bool isUpdate) => isUpdate
      ? selectedPenghasilanOrtuIdUpdate
      : selectedPenghasilanOrtuIdCreate;
  ...
  void setSelectedPenghasilanOrtuIdCreate(int? value) {
    selectedPenghasilanOrtuIdCreate = value;
    notifyListeners();
  }
  ...
  void setSelectedPenghasilanOrtuIdUpdate(int? value) {
    selectedPenghasilanOrtuIdUpdate = value;
    notifyListeners();
  }
  ...
  void fillDataFromKartuKeluarga(NikHive nikData, AgamaData? agama, Datum? jk,
    ...
    tempatLahirControllerCreate.text = nikData.tempatLahir;
    tanggalLahirControllerCreate.text = nikData.tanggalLahir;

    // Set dropdown values
    selectedKelaminIdCreate = jk?.id;
    selectedAgamaIdCreate = agama?.id;
    selectedPekerjaanOrtuIdCreate = pekerjaan?.id;
  ...
  Future<int> submitFormCreate(BuildContext context) async {
    ...
    try {
      if (selectedHubunganIdCreate == null ||
          ...
          selectedPenghasilanOrtuIdCreate == null ||
      ...
      final Map<String, dynamic> data = {
        ...
        'nama': namaAnakControllerCreate.text,
        ...
        'nama_ortu': namaOrtuControllerCreate.text,
        'pekerjaan': selectedPekerjaanOrtuIdCreate,
        'penghasilan': selectedPenghasilanOrtuIdCreate,
  ...
  void fillFormWithExistingDataUpdate({
    ...
    try {
      ...
      selectedPenghasilanOrtuIdUpdate = findIdByName(
        penghasilanList,
      ...
      debugPrint(
          'selectedPenghasilanIdUpdate: $selectedPenghasilanOrtuIdUpdate');
  ...
  Future<int> updateForm(BuildContext context, String detailId) async {
    ...
    try {
      ...
      if (selectedNikIdUpdate == null ||
          ...
          selectedPenghasilanOrtuIdUpdate == null ||
      ...
      final Map<String, String> data = {
        ...
        'nama': namaAnakControllerUpdate.text,
        ...
        'nama_ortu': namaOrtuControllerUpdate.text,
        'pekerjaan': selectedPekerjaanOrtuIdUpdate.toString(),
        'penghasilan': selectedPenghasilanOrtuIdUpdate.toString(),
